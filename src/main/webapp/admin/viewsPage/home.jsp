	...
	<div class="container">
		<ul class="navbar-nav mr-auto" style="margin-left: 350px;">
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/Index?action=first&page=1">
					<button type="button" class="btn btn-info">|<</button>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/Index?action=prev&page=${currentPage - 1}">
					<button type="button" class="btn btn-info"><<</button>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/Index?action=next&page=${currentPage + 1}">
					<button type="button" class="btn btn-info">>></button>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="<%=request.getContextPath()%>/Index?action=last&page=${totalPages}">
					<button type="button" class="btn btn-info">>|</button>
			</a></li>
		</ul>
	</div>
