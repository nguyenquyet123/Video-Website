			...
			<div class="col-md-2">
				<div class="card-textfa-pull-left" style="background-color: white;">
					...
					<ul class="list-group list-group-flush" id="cungcap"
						style="background-color: white; border: none;">
						<li class="list-group-item border-0"><a href="Index"><i
								class="fa-solid fa-house">Home</i></a></li>
						<c:if test="${ isLogin }">
							<li class="list-group-item border-0"><a href="Video"><i
									class="fa-brands fa-youtube">Videos</i></a></li>
							<li class="list-group-item border-0"><a href="Users"><i
									class="fa-solid fa-users">Users</i></a></li>
							<li class="list-group-item border-0"><a href="Report"><i
									class="fa-solid fa-square-poll-vertical">Reports</i></a></li>
							<li class="list-group-item border-0"><a href="LogoffAdmin"><i
